...
export enum CreatureSpriteIndex {
    ...
    GoblinMage=3964,Goblinchief=3963,GoblinLeader=3842,
    ...
    Wilderness=2164,Defiance=1882,Pollution=2132,Monk=4943,Law=2521,Goblin2=3860,Goblin3=3962,Bear=4019,Knight=4371,
    ...
    FireImp=4212,Gorilla=4023,ArmoredTortoise=4009,Longbowmen=3783,Scry=1982,Blizzard=2031,Riot=3902,SpiritsOfWorldTree=6038,
    BurrowingWurm=4173,MercenaryCaptain=3854,DrometaurSpearhand=3984,SandElemental=1214,RhinoCharge=4047,BallLightning=1909,
    Stylite=4601,Archangel=4978,LizardMage=3951,SteamElemental=4436,Cycle=2194,GreatHive=4107,Justice=1817,CullWeaklings=3078,
    ...
    Erosion=1494,DivineReach=1834,Fog=1711,ForkLightning=1847,RedwoodTreant=4713,GreenMerchant=4928,Bruiser=4936,RedMerchant=3934,
    Mummy=4435,MasterMummy=3871,ForestMoth=3911,SnakeMan=3849,FireLizard=3949,Purify=2635,AngelicWarning=2192
}
...
export const ModifierDesc:Record<Modifier,{title:string, description:string}> = {
    [Modifier.Seige]:{title: 'Seige', description: 'Can only move if opposing a tower, city, or temple'},
    [Modifier.StingingWinds]:{title: 'Stinging Winds', description:'If a creature enters this lane, it gains haste. If it leaves it loses haste.'},
    [Modifier.Retribution]: {title: 'Retribution',description:'During the next combat, destroy any creature that kills another creature.'},
    [Modifier.GreenProducer]: {title: 'Greening',description:'This land also produces green mana.'},
    [Modifier.Unblockable]: {title: 'Ethereal',description:"This creature can't enter combat."},
    [Modifier.DementiaCloud]: {title: 'Fumes',description:'When this creature dies, all players must dicard a card at random.'},
    [Modifier.SlowReturn]: {title: 'Echo',description:"This creature returns to the top of owner's codex when destroyed."},
    [Modifier.BeeSting]: {title: 'Swarming',description:'Tap to deal 1 to target creature instead of producing mana'},
    [Modifier.Undying]: {title: 'Undying',description:'When destroyed, returns to hand'},
    [Modifier.Consecrate]: {title: 'Consecrated',description:'When this creature dies, owner gains 3 life'},
    [Modifier.Defender]: {title: 'Defender',description:'Does not move during combat'},
    [Modifier.Banding]: {title: 'Banding',description:''},
    [Modifier.Haste]: {title: 'Haste',description:'Moves an extra time during combat phase unless blocked'},
    [Modifier.Ranged]: {title: 'Ranged',description:'Creature may tap to deal its power to another creature in lane, exactly 2 squares away'},
    [Modifier.Timid]: {title: 'Timid',description:"Can't be placed in a lane with another creature"},
    [Modifier.DesertWalk]: {title: 'Pathfinder - Desert',description:'If opposing land is a desert, this creature is unblockable'},
    [Modifier.ForestWalk]: {title: 'Pathfinder - Forest',description:'If opposing land is a forest, this creature is unblockable'},
    [Modifier.CityWalk]: {title: 'Pathfinder - City',description:'If opposing land is a city, this creature is unblockable'},
    [Modifier.TowerWalk]: {title: 'Pathfinder - Tower',description:'If opposing land is a tower, this creature is unblockable'},
    [Modifier.TempleWalk]: {title: 'Pathfinder - Temple',description:'If opposing land is a temple, this creature is unblockable'},
    [Modifier.CityAffinity]: {title: 'Affinity - City', description:'May only be placed in a lane where there is a city'},
    [Modifier.ForestAffinity]: {title: 'Affinity - Forest',description:'May only be placed in a lane where there is a forest'},
    [Modifier.TowerAffinity]: {title: 'Affinity - Tower',description:'May only be placed in a lane where there is a tower'},
    [Modifier.DesertAffinity]: {title: 'Affinity - Desert',description:'May only be placed in a lane where there is a desert'},
    [Modifier.SanctuaryAffinity]: {title: 'Affinity - Sactuary',description:'May only be placed in a lane where there is a temple'},
    [Modifier.Vigilant]: {title: 'Vigilant',description:'Cannot be targeted by sorcery or enchantments'},
    [Modifier.Nimble]: {title: 'Nimble',description:'May tap to displace left or right 1 lane'},
    [Modifier.ProtectionFromBlack]: {title: 'Protection from City',description:"Can't be targeted by city creatures or spells"},
    [Modifier.ProtectionFromBlue]: {title: 'Protection from Spirit',description:"Can't be targeted by tower creatures or spells"},
    [Modifier.ProtectionFromGreen]: {title: 'Protection from Forest',description:"Can't be targeted by forest creatures or spells"},
    [Modifier.ProtectionFromRed]: {title: 'Protection from Desert',description:"Can't be targeted by desert creatures or spells"},
    [Modifier.ProtectionFromWhite]: {title: 'Protection from Holy',description:"Can't be targeted by temple creatures or spells"},
    [Modifier.Taunt]: {title: 'Taunt',description:"Other creatures may not leave this creature's lane."},
    [Modifier.Fearsome]: {title: 'Fearsome',description:'Other creatures cannot be placed in this lane'},
    [Modifier.Toxic]: {title: 'Toxic', description:'Creatures with def 3 or less are destroyed'},
}
