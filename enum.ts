...
export enum IconIndex {
    ...
    Damage=3302,Tap=3733,Red=2742,Blue=2751,Green=2722,Black=2741,White=2743,Gray=2736,
...
export enum CardType {
    ...
    HoodooHealer='WitchDoctor', LifeSteal='LifeSteal', Grizzly='Grizzly', GuardianAngel='GuardianAngel',
